...
/**
 * Base class that represents a row from the 'related_product' table.
 *
 *
 *
 * @package    propel.generator.up-sell.om
 */
abstract class BaseRelatedProduct extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'src\\Model\\RelatedProductPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        RelatedProductPeer
     */
     ...
     * @return RelatedProduct The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = RelatedProductPeer::ID;
        }
    ...
    public function setUpSellId($v)
    {
        ...
        if ($this->up_sell_id !== $v) {
            $this->up_sell_id = $v;
            $this->modifiedColumns[] = RelatedProductPeer::UP_SELL_ID;
        }
    ...
    public function setProductId($v)
    {
        ...
        if ($this->product_id !== $v) {
            $this->product_id = $v;
            $this->modifiedColumns[] = RelatedProductPeer::PRODUCT_ID;
        }
    ...
    public function setVariantSelected($v)
    {
        ...
        if ($this->variant_selected !== $v) {
            ...
            $this->modifiedColumns[] = RelatedProductPeer::VARIANT_SELECTED;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 4; // 4 = RelatedProductPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating RelatedProduct object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = RelatedProductPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = RelatedProductQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                RelatedProductPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(RelatedProductPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(RelatedProductPeer::UP_SELL_ID)) {
            $modifiedColumns[':p' . $index++]  = '`up_sell_id`';
        }
        if ($this->isColumnModified(RelatedProductPeer::PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`product_id`';
        }
        if ($this->isColumnModified(RelatedProductPeer::VARIANT_SELECTED)) {
            $modifiedColumns[':p' . $index++]  = '`variant_selected`';
        }

        $sql = sprintf(
            'INSERT INTO `related_product` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = RelatedProductPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = RelatedProductPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RelatedProduct'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['RelatedProduct'][$this->getPrimaryKey()] = true;
        $keys = RelatedProductPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RelatedProductPeer::ID)) $criteria->add(RelatedProductPeer::ID, $this->id);
        if ($this->isColumnModified(RelatedProductPeer::UP_SELL_ID)) $criteria->add(RelatedProductPeer::UP_SELL_ID, $this->up_sell_id);
        if ($this->isColumnModified(RelatedProductPeer::PRODUCT_ID)) $criteria->add(RelatedProductPeer::PRODUCT_ID, $this->product_id);
        if ($this->isColumnModified(RelatedProductPeer::VARIANT_SELECTED)) $criteria->add(RelatedProductPeer::VARIANT_SELECTED, $this->variant_selected);
    ...
    {
        $criteria = new Criteria(RelatedProductPeer::DATABASE_NAME);
        $criteria->add(RelatedProductPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of RelatedProduct (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return RelatedProduct Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return RelatedProductPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new RelatedProductPeer();
        }
    ...
    public function getUpSell(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aUpSell === null && ($this->up_sell_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUpSell->addRelatedProducts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(RelatedProductPeer::DEFAULT_STRING_FORMAT);
    }
