...
abstract class BaseProductInCartPeer
{
    ...
    const VARIANT_SELECTED = 'product_in_cart.variant_selected';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProductInCartPeer::ID, ProductInCartPeer::UP_SELL_ID, ProductInCartPeer::PRODUCT_ID, ProductInCartPeer::VARIANT_SELECTED, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ProductInCartPeer::ID => 0, ProductInCartPeer::UP_SELL_ID => 1, ProductInCartPeer::PRODUCT_ID => 2, ProductInCartPeer::VARIANT_SELECTED => 3, ),
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ProductInCartPeer::VARIANT_SELECTED);
        } else {
